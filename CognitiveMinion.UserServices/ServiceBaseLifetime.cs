...
namespace CognitiveMinion.UserServices
{
    ...
    public class ServiceBaseLifetime : ServiceBase, IHostLifetime
    {
        ...
        public ServiceBaseLifetime(IHostApplicationLifetime applicationLifetime) => ApplicationLifetime = applicationLifetime ?? throw new ArgumentNullException(nameof(applicationLifetime));
